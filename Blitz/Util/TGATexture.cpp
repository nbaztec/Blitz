...
bool LoadTGA(TextureInfo * texture, const char * filename)				// Load a TGA file
{
...
bool LoadUncompressedTGA(TextureInfo * texture, const char * filename, FILE * fTGA)	// Load an uncompressed TGA (note, much of this code is based on NeHe's 
...
bool LoadCompressedTGA(TextureInfo * texture, const char * filename, FILE * fTGA)		// Load COMPRESSED TGAs
{ 
